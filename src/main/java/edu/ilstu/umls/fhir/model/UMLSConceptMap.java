...
@ResourceDef(name = "ConceptMap", profile = Utils.BASE_URL + "/umlsfhi/fhir/StructureDefinition/UMLSConceptMap")
public class UMLSConceptMap extends ConceptMap {
	...
	public static class UMLSSourceElementComponent extends ConceptMap.SourceElementComponent {
		...
		@Extension(url = Utils.BASE_URL
				+ "/umlsfhir/fhir/StructureDefinition/conceptmap-code-semantic-type", definedLocally = true, isModifier = false)
	...
	public static class UMLSTargetElementComponent extends TargetElementComponent {
		...
		@Extension(url = Utils.BASE_URL
				+ "/umlsfhir/fhir/StructureDefinition/conceptmap-target-mapping-label", definedLocally = true, isModifier = false)
		...
		@Extension(url = Utils.BASE_URL
				+ "/umlsfhir/fhir/StructureDefinition/conceptmap-target-mapping-type", definedLocally = true, isModifier = false)
	...
	public static UMLSConceptMap getDefaultUMLSConceptMap() {
		...
		model.setUrl(Utils.BASE_URL + "/umlsfhir/");
